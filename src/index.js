...
const createWindow = async () => {
  const mainWindow = new BrowserWindow({
    width: 1300,
    height: 800,
    icon: path.join(__dirname, 'icons/nex.ico'), // TODO: Support a mac icon
    webPreferences: {
  ...
  // Catch nex:// parameters on windows
  ...
  mainWindow.webContents.on('will-navigate', (event, url) => {
    ...
    if (url.startsWith('https://nexhotel.net/disconnected')) {
